...
export default function Hero() {
    return (
        ...
        <div className="relative flex border-red-800 border-solid border-2  flex-col items-center max-w-screen-xl px-4 m-auto md:flex-row sm:px-6 p-8">
            <div className="flex items-center py-5 md:w-1/2 md:pb-20 border-red-800 border-solid border-2 md:pt-10 md:pr-10">
                <div className="text-left border-red-800 border-solid border-2">
                    <h2
